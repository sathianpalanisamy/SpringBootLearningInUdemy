...
public class CurrencyConversionController {
	...
	public CurrencyConversion calculateCurrencyConversion(@PathVariable String from, @PathVariable String to,
		...
		return new CurrencyConversion(currencyConversion.getId(), from, to,
				...
				currencyConversion.getEnvironment() + " resttemplete");

	}

	@GetMapping("/currency-conversion-feign/from/{from}/to/{to}/quantity/{quantity}")
	public CurrencyConversion calculateCurrencyConversionFeigm(@PathVariable String from, @PathVariable String to,
			@PathVariable BigDecimal quantity) {
